...
#define UNIT                    2    // Unitnumber, set to non-zero (0:multicast, 1:gateway,2-254:clients,255:reserved)
...
#define LORA_RESET              4
#define LORA_DIO0               7
#define LORA_SF                 9    // 6-12
#define LORA_BW             250E3    // 7800 - 500000
#define LORA_CODE               5    // 5-8
#define LORA_SYNC            0x12    // default setting of 0x12, LoRaWAN setting is 0x34, change to unique to isolate
#define LEDPIN                 13    // change -1 if not used, or the LED ping GPIO

#define USES_P001   // Switch  -- TaskDevicePin1
#define USES_P002   // ADC    344bytes --  TaskDevicePort
#define USES_P003   // Pulse  ~1.8kB TaskDevicePin1
#define USES_P005   // DHT    ~1.3kB TaskDevicePin1
...
#define WAIT_SERIAL_AT_STARTUP  false  // set to false to let the sketch to run independent!!

// SLEEP OPTIONS
#define SLEEP_RADIO_AFTERSEND   true  // put radio to sleep mode after each transmission
#define DISABLE_ADC             true  // disable ADC at startup
#define AUTO_DISABLE_ADC        true  // disable ADC after each analogread
...
#ifdef USES_P002
 #define DISABLE_ADC            false
#endif

#if DISABLE_ADC
 #define AUTO_DISABLE_ADC       false
#endif

#if (defined(USES_P034) || defined(USES_P010) || defined(USES_P014) || defined(USES_P028)|| defined(USES_P051))
 #define FEATURE_I2C            true
 #define DISABLE_I2C            false
#else
 #define FEATURE_I2C            false
#endif

#if DISABLE_ADC || DISABLE_USART || DISABLE_I2C
 #include <avr/power.h>
#endif
...
#define UNIT_MAX                          254
#define RULES_TIMER_MAX                     1
#define SYSTEM_TIMER_MAX                    1 // ESP Easy  8
