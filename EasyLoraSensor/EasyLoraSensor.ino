...
void setup()
{
  ...
  */
  Settings.TaskDevicePin1PullUp[1]=0; // set 1 to make Task1 to use pullup
...
{
  yield();
  // timed IDLE sleep has to be implemented, maybe: https://github.com/rocketscream/Low-Power
}
